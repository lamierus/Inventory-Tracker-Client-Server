...
namespace Inventory_Tracker_Server {
    public partial class InventoryServerForm : Form {
        ...
        /// <param name="e"></param>
        private void TrackerServerForm_Activated(object sender, EventArgs e) {
            if (!WindowDrawn) {
                WindowDrawn = true;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TrackerServerForm_Closing(object sender, FormClosingEventArgs e) {
            serverSocket.Stop();
            AcceptClients.Abort();
            do {
